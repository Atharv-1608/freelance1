...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#f2f3f4] shadow-inner">
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          <h3 className="text-3xl font-classy text-gray-800 ">Sanskruti.</h3>
          <p className="mt-2 text-xl font-classy ">Enhancing Beauty, Crafting Confidence</p>
        </div>
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/makeupnhairbysanskruti/" className=" hover:text-gray-800 transition-colors" >
              <IoLogoInstagram size={27} />
            </a>
            <a href="mailto:sanskrutibhogate@gmail.com" className=" hover:text-gray-800 transition-colors" >

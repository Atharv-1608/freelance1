...
const Carousel2 = () => {
  ...
  return (
    <div className="relative w-full max-w-sm mx-auto h-[560px] overflow-hidden sm:mt-[-3em]">
      <div 
      ...
      >
        {images.map((image, index) => (
          <img
            ...
            src={image.src}
            alt={image.alt}
            className="w-full h-[550px] object-contain flex-shrink-0"
          />
        ))}
      </div>
      ...
      {/* Dots Indicator */}
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:mb-[100px] lg:mb-6 ">
        {images.map((_, index) => (
          <button
            key={index}

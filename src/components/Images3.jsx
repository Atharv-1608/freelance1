...
const Images3 = () => {
  const slides = [
    {
      url: 'https://res.cloudinary.com/dribsk7iy/image/upload/v1729931344/IMG_8552_psyjeq.jpg',
    },
    {
      url: 'https://res.cloudinary.com/dribsk7iy/image/upload/v1729931340/IMG_8553_egjeey.jpg',
    },
    {
      url: 'https://res.cloudinary.com/dribsk7iy/image/upload/v1729931340/IMG_8554_bijzwi.jpg',
    },
  ];
      ...
      <div className='w-full max-w-[500px] aspect-[3/4] relative group'>
        <div className='w-full h-full rounded-2xl overflow-hidden shadow-lg'>
          <img
            ...
            className='w-full h-full object-contain rounded-2xl px-5'
          />
        </div>
